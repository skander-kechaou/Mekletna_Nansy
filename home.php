        ...
        <div class="row justify-content-between gy-5">
          ...
          >
            ...
            <p data-aos="fade-up" data-aos-delay="100">
              Eat authetic Tunisan food and help out small buissnesses.
            </p>
            <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
              <a href="#book-a-table" class="btn-book-a-table">Order Food</a>
              <a
            ...
            >
              <div class="content ps-0 ps-lg-5">
                <p class="fst-italic">
                  ...
                  for small buissness and those who are passionate about home
                  made Tunisan food a clientel .
                </p>
                <ul>
                  <li>
                    <i class="bi bi-check2-all"></i> Some of our proceeds along
                    with meals offred by the chefs will be donated.
                  </li>
                  <li>
                    <i class="bi bi-check2-all"></i> All of our foods are 100%
                    Tunisan made by Tunisans.
                  </li>
                  <li>
              ...
              <div class="row gy-4">
                <div class="col-xl-4" data-aos="fade-up" data-aos-delay="200">
                  ...
                  >
                    ...
                    <h4>You will help out small buissness.</h4>
                  </div>
                </div>
                <!-- End Icon Box -->
                ...
                <div class="col-xl-4" data-aos="fade-up" data-aos-delay="300">
                  ...
                  >
                    <i class="bi bi-gem"></i>
                    <h4>You will eat authetic Tunisan food.</h4>
                  </div>
                </div>
                <!-- End Icon Box -->
