...
<html lang="en">
  <head>
    ...
    <title>Add Chef - Dashboard HTML Template</title>
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-xl">
      <div class="container h-100">
        <a class="navbar-brand" href="Chef.html">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto h-100">
            <li class="nav-item">
              <a class="nav-link" href="chef.html">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="dashboardchef.php">
                <i class="fas fa-shopping-cart"></i>Chefs
              </a>
            </li>
      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Add Region </h2>
              </div>
            </div>
            <div class="row tm-edit-product-row">
              ...
              <div class="col-12">
                <button type="submit" class="btn btn-primary btn-block text-uppercase" value="Save">Add Region  Now</button>
              </div>
            </form>
            </div>
          </div>
