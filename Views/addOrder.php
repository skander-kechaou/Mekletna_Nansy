...
{ ?-->
                    <li>
                        <div class="mini-cart-thumb">
                            <a href="#"><img src="C:\xampp\htdocs\CRUD\views\assets\img\coucous.jpg" alt=""></a>
                        </div>
                        <div class="mini-cart-heading">
                            <h5><a href="#">
                                    <!--?PHP echo $row['Nom_Commande']; ?-->
                                </a></h5>
                            <span>
                                <!--?PHP echo $row['Prix']; ?-->
                            </span>
                        ...
                        <div class="mini-cart-remove">
                            <button><i class="bi bi-trash3-fill" aria-hidden="true"></i></button>
                        </div>
                    </li>
                    <li>
                        <div class="mini-cart-total">
                            <h5>Total: 0.00 TND</h5>
                        </div>
                ...
                <div class="col-lg-8 d-flex align-items-center reservation-form-bg">
                    ...
                    <form action="" method="post" role="form" id="form" data-aos="fade-up" data-aos-delay="100">
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <input type="number" name="idClient" placeholder="client" id="idClient" maxlength="20">
                                <div class="validate"></div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <input type="number" name="priceOrder" placeholder="price" id="priceOrder" maxlength="20">
                                <div class="validate"></div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <input type="number" name="statusOrder" placeholder="stat" id="statusOrder" maxlength="20">
                                <div class="validate"></div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <input type="date" name="dateOrder" placeholder="date" id="dateOrder">
