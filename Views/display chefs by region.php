...
$sql="SELECT * FROM region INNER JOIN chef ON region.id_region=chef.Reg ";
            ...
            <!-- row -->
                ...
                <div class="col-12 tm-block-col">
                    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                        <h2 class="tm-block-title">Available Chefs </h2>
                        <table class="table">
                            <thead>
                                <tr>
...
<td><?php echo $row["Name_chef"]; ?></td>
<td><?php echo $row["Add_chef"]; ?></td>
<td><?php echo $row["mail_chef"]; ?></td>
