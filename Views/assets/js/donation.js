document.getElementById("become-a-donation").addEventListener("submit", (e) => {
    e.preventDefault();
    let Name = document.querySelector("#Name_Assio").value;
    checkname();
    check_phonenumber();
}
)
...
function checkname() {
    const name = document.getElementById("Name_Assio").value;
