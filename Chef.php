         ...
         It has a journey.
          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
              <div class="chef-member">
                <div class="member-img">
                  <img src="views/assets/img/chefs/chefs-1.jpg" class="img-fluid" alt="">
                  <div class="social">
                ...
                <div class="member-info">
                  <h4>Omar</h4>
                  <span>Chef specialized in Tunisian north traditional food.</span>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
              <div class="chef-member">
                <div class="member-img">
                  <img src="views/assets/img/chefs/chefs-2.jpg" class="img-fluid" alt="">
                  <div class="social">
                    <a href=""><i class="bi bi-star"></i></a>
                    <a href=""><i class="bi bi-star"></i></a>
                    <a href=""><i class="bi bi-star"></i></a>
                ...
                <div class="member-info">
                  <h4>Samia</h4>
                  <span>Chef specialized in Tunisian West traditional food.</span>
                </div>
              </div>
            </div><!-- End Chefs Member -->
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
              <div class="chef-member">
                <div class="member-img">
                  <img src="views/assets/img/chefs/chefs-3.jpg" class="img-fluid" alt="">
                  <div class="social">
                    <a href=""><i class="bi bi-star"></i></a>
                    <a href=""><i class="bi bi-star"></i></a>
                    <a href=""><i class="bi bi-star"></i></a>
                ...
                <div class="member-info">
                  <h4>Mohamed</h4>
                  <span>Chef specialized in Tunisian south traditional food.</span>
                </div>
              </div>
            </div><!-- End Chefs Member -->
